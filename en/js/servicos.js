...
class Servico {
  ...
  constructor() {
    ...
    this.arrayServico = [{
      id: 1,
      categoria: 'Logistics Consulting',
    ...
    {
      id: 9,
      categoria: 'Insurance and Storage',
  ...
  validarCampos(servico) {
    ...
    if (servico.categoria == '') {
      msg += '- inform the service category \n'
    }
    if (servico.nomeRazaoSocial == '') {
      msg += '- inform the name or company name \n'
    }
    if (servico.cpfCnpj == '') {
      msg += '- inform the CPF or CNPJ \n'
    }
    if (servico.email == '') {
      msg += '- inform the email \n'
    }
    if (servico.telefone == '') {
      msg += '- inform the phone \n'
    }
    if (msg != '') {
      alert(msg)
      return false
