...
function consultaTempoReal() {
    ...
    fetch(`https://economia.awesomeapi.com.br/last/USD-BRL`)
        .then(response => {
            response.json()
                .then(data => $('#cotacao').text('Real time: ' + data['USDBRL']['bid']))
        })
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="color: #F1BE07";>
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                <li class="nav-item fontColorNav" >
                    <a class="nav-link active" aria-current="page" href="/queopsmaritime/en/index.html">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/queopsmaritime/en/sobreNos.html">About us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/queopsmaritime/en/servicos.html">
                        Services
                    </a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="/queopsmaritime/en/cotacao.html">
                Quotation
            </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/queopsmaritime/en/contato.html">
                        Contact-us
                    </a>
                </li>
                <li class="nav-item">
