...
function calcBid(bidList) {
    ...
    $('#menor').text('Lowest quotation: R$:' + menorBid)
    let maiorBid = bidList.sort((a, b) => a - b).at(-1)
    $('#maior').text('Highest quotation: R$:' + parseFloat(maiorBid).toFixed(2) )
    let variacaoBid = (((maiorBid - menorBid) / menorBid) * 100).toFixed(2)
    $('#variacao').text('Variation in Period: ' + variacaoBid+"%")
    let bidMedio = (bidTotal / bidList.length).toFixed(2)
    $('#media').text('Average in the period: R$' + bidMedio)
...
function signOut() {
    ...
    auth2.signOut().then(function () {
        document.getElementById('dropText').innerText = "Registrer/ Login"
        let logImg = document.getElementById('loginImg')
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="color: #F1BE07";>
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/en/sobreNos.html">Sobre nosotros</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/en/servicos.html">
                        Services
                    </a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="/en/cotacao.html">
                Quotation
            </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/en/contato.html">
                        Contact-us
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    <a id="dropHead" class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink"
                        ...
                        <img id='loginImg' alt="" src="imagens/person-circle.svg" class="loginImg bi bi-person-circle"
                            viewBox="0 0 16 16">
                        <span id="dropText">Register / Login</span>
                    </a>
...
<div class="row d-flex justify-content-between" style="background-color: #F1BE07; color:#1F6D69">
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 font-weight-bold">
    360-day variation:</div>
    ...
    <div class="container-fluid text-warning" style="background-color: #1F6D69;">
        <div class="row">
            <div class="col-lg-3 col-md-12 my-3">
                ...
                <div class="row d-flex justify-content-center pointer" onclick="window.location='/en/sobreNos.html'" >Sobre Nós</div>
                <div class="row d-flex justify-content-center pointer" onclick="window.location='href="/en/servicos.html'">Serviços</div>
                <div class="row d-flex justify-content-center pointer" onclick="window.location='href="/en/cotacao.html'">Cotação</div>
                 <div class="row d-flex justify-content-center pointer" onclick="window.location='href="/en/contato.html>Contato</div>
            </div>
            ...
            <div class="col-lg-4 col-md-12-d my-3">
                <div class="row d-flex justify-content-center">Contact us</div>
        ...
        <div class="row d-flex justify-content-center" style="background-color: #1F6D69; color:"#F1BE07">
         Copyright © 2021 Queops Maritime | All rights reserved | Policies of
         Privacy | Policies of
             Cookies
            </div>
        </div>
...
function tratarCNPJ(dado) {
    ...
    if (dadosCNPJ.situacao != "ATIVA") {
        ...
        $('#alerta').text('Quotes only for active CNPJs')
            abrirModalAlerta()
    } else {
...
function validarForm() {
    if ($("#razaoSocial").val().length < 3) {
        $('#alerta').text('Please fill in the form correctly')
            abrirModalAlerta()
